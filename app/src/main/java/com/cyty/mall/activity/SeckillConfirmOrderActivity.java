 ...
 * 确认订单
 */
public class SeckillConfirmOrderActivity extends BaseActivity {
    ...
    public static void startActivity(Context mContext, String ids) {
        Intent mIntent = new Intent(mContext, SeckillConfirmOrderActivity.class);
    ...
    private void confirmOrder() {
        HttpManager.getInstance().seckillConfirmOrder(ids,
                    ...
                    public void onResponse(boolean result, String message, HttpResponse.WXOrderPayResponse data) {
                        if (result) {
                            ...
                            builder.setAppId(signInfo.getAppid())
                                    ...
                                    .build().toWXPayNotSign(SeckillConfirmOrderActivity.this);
                        } else {
                            ToastUtils.show(message);
    ...
    private void payForAli(final String orderinfo) {
        Runnable payRunnable = new Runnable() {
            ...
            @Override
            public void run() {
                PayTask alipay = new PayTask(SeckillConfirmOrderActivity.this);
