...
public class AppraiseAdapter extends BaseQuickAdapter<AppraiseInfo, BaseViewHolder> {

    private ImageAdapter imageAdapter;
    private List<String> imgUrls = new ArrayList<>();

    public AppraiseAdapter(@Nullable List<AppraiseInfo> data) {
        super(R.layout.item_product_review, data);
    }
