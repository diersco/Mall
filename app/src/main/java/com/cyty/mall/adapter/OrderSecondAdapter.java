 ...
 * @描述
 */
public class OrderSecondAdapter extends BaseQuickAdapter<OrderListInfo.OrderDetailsListBean, BaseViewHolder> {


    public OrderSecondAdapter(@Nullable List<OrderListInfo.OrderDetailsListBean> data) {
        super(R.layout.item_order_second, data);
    }

    @Override
    protected void convert(@NotNull BaseViewHolder baseViewHolder, OrderListInfo.OrderDetailsListBean orderDetailsListBean) {
