...
public class GoodsFormatAdapter extends TagAdapter {
    Context mContext;
    List<GoodsInfo.SpecListBean> specListBeanList = new ArrayList<>();
    private TextView tvName;
    private int clickPosition = 0;

    public GoodsFormatAdapter(Context mContext, List<GoodsInfo.SpecListBean> datas) {
        super(datas);
    ...
    public View getView(FlowLayout parent, int position, Object o) {
        ...
        tvName.setText(specListBean.getSpecOne());
    ...
    public void setData(List<GoodsInfo.SpecListBean> datas) {
