...
public class AfterSalesInfo implements Parcelable {
    ...
    protected AfterSalesInfo(Parcel in) {
    ...
    public static final Creator<AfterSalesInfo> CREATOR = new Creator<AfterSalesInfo>() {
        @Override
        public AfterSalesInfo createFromParcel(Parcel in) {
            return new AfterSalesInfo(in);
        }

        @Override
        public AfterSalesInfo[] newArray(int size) {
            return new AfterSalesInfo[size];
        }
    };
