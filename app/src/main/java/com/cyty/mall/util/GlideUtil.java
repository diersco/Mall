...
//                .format(DecodeFormat.PREFER_ARGB_8888) // 设置图片解码格式, 默认 8888
    ...
    public static RequestOptions transformationOptions(final RequestOptions options, final Transformation transformation) {
        if (options != null) {
            try {
                ...
                LogUtils.eTag(TAG, e, "transformationOptions");
            }
        }
        return options;
    }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    LogUtils.eTag(TAG, e, "clearDiskCache");
                }
            }
        }).start();
    }
    ...
    public static void clearMemoryCache() {
        try {
            ...
            LogUtils.eTag(TAG, e, "clearMemoryCache");
        }
    }
    ...
    public static void onLowMemory() {
        try {
            ...
            LogUtils.eTag(TAG, e, "onLowMemory");
        }
    }
    ...
    public static File getDiskCache() {
        try {
            ...
            LogUtils.eTag(TAG, e, "getDiskCache");
        }
        return null;
    }
}